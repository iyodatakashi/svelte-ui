...
export { default as Skeleton } from './components/skelton/Skeleton.svelte';
export { default as SkeletonText } from './components/skelton/SkeletonText.svelte';
export { default as SkeletonBox } from './components/skelton/SkeletonBox.svelte';
export { default as SkeletonAvatar } from './components/skelton/SkeletonAvatar.svelte';
